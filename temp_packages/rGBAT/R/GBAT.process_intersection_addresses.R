...
#' @title Geocode a data frame of NYC intersection addresses with a user selected release or version of DCP's Geosupport.
#' @name GBAT.process_intersection_addresses
#' @aliases GBAT.process_intersection_addresses
#' @export GBAT.process_intersection_addresses
...
#' @usage GBAT.process_intersection_addresses(in_df,  
...
#' @examples #create a data frame of intersection addresses
...
GBAT.process_intersection_addresses <- function(in_df, street1_col_name, street2_col_name, boro_code1_col_name, source_cols, geocode_fields,boro_code2_col_name=NULL, com_dir_col_name=NULL, return_type = "all", GBAT_name) { 

	return(parallel.GBAT.process_intersection_addresses(1, in_df, street1_col_name, street2_col_name, boro_code1_col_name, source_cols, geocode_fields, boro_code2_col_name, com_dir_col_name, return_type, GBAT_name))
